import{u as F,L as b}from"./Loading-BOpo1Dsf.js";import{g as D}from"./lil-gui.module.min-Bc0DeA9g.js";import{_ as I,g as q,o as B,c as k,w as j,a as L,u as V}from"./index-BuZSTuB0.js";import"./allscreen-B5_i54WS.js";import"./loading-Cldb6aZY.js";const z={__name:"Demo26",setup(A){const r=new D;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:t,renderer:C})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
