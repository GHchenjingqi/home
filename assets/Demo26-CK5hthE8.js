import{u as F,L as b}from"./Loading-CWFZPSwi.js";import{g as D}from"./lil-gui.module.min-Bc0DeA9g.js";import{_ as I,h as q,b as B,c as k,w as j,d as L,u as V}from"./index-CIeIexVd.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./allscreen-B9PGqhro.js";import"./loading-H6oYD2Od.js";const z={__name:"Demo26",setup(A){const r=new D;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:t,renderer:h})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
