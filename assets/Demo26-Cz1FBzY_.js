import{u as b,L as D}from"./Loading-C2vwFjpW.js";import{g as I}from"./lil-gui.module.min-Bc0DeA9g.js";import{_ as k,g as q,o as B,c as j,w as L,a as V,u as z}from"./index-C_oHrnUh.js";import"./allscreen-DKMNClLa.js";import"./loading-D7GcMhyS.js";const A={__name:"Demo26",setup(G){const r=new I;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let g=null,a=null;const y=async({THREE:e,scene:o,controls:w,canvas:C,camera:t,renderer:N,clock:_})=>{g=_;let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
