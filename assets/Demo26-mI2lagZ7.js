import{u as F,L as b}from"./Loading-DBBrhrXu.js";import{g as D}from"./lil-gui.module.min-BH_YJbPT.js";import{_ as I,g as q,c as B,b as k,w as j,u as L,d as V}from"./index-BIF3Vx7O.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./allscreen-Cvg-P0Ml.js";import"./loading-CQTYwYxD.js";const z={__name:"Demo26",setup(A){const r=new D;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:t,renderer:C})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
