import{u as F,L as b}from"./Loading-DFVB7pqE.js";import{g as I}from"./lil-gui.module.min-Bc0DeA9g.js";import{_ as q,g as B,b as k,c as D,w as j,d as L,u as V}from"./index-B4xWM6pg.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./allscreen-BLpajn7o.js";import"./loading-BOZmDY10.js";const z={__name:"demo26",setup(A){const r=new I;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:t,renderer:C})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
