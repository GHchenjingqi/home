import{u as F,L as b}from"./Loading-DqHcFzpL.js";import{g as I}from"./lil-gui.module.min-BH_YJbPT.js";import{_ as q,g as B,c as k,b as D,w as j,u as L,d as V}from"./index-Bvcxl4rW.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./allscreen-CP3ARXoZ.js";import"./loading-QOaArefD.js";import"https://ghchenjingqi.github.io/resources/mds/pathList.js";const z={__name:"demo26",setup(A){const r=new I;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:l,renderer:C})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
