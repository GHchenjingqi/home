import{u as F,L as b}from"./Loading-z6EJ6wNw.js";import{g as I}from"./lil-gui.module.min-BH_YJbPT.js";import{_ as q,g as B,c as k,b as D,w as j,u as L,d as V}from"./index-B1ovB_mj.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./allscreen-BAGeJPJY.js";import"./loading-CvMl4ZZs.js";import"https://fastly.jsdelivr.net/gh/GHchenjingqi/resources/mds/pathList.js";const z={__name:"demo26",setup(A){const r=new I;r.domElement.style.top="2rem",r.domElement.style.right="2rem";let a=null;const y=async({THREE:e,scene:o,controls:g,canvas:w,camera:l,renderer:C})=>{let i={vTime:{value:0},vColor:{value:new e.Color(65280)},vPow:{value:2}};const v=`varying vec2 vUv;
        void main(){
            vUv = vec2(uv.x,uv.y);
