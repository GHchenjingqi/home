...
<font style="color:rgb(34, 34, 34);">将 </font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">bindgetphonenumber</font>`<font style="color:rgb(34, 34, 34);"> 事件回调中的动态令牌</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">传到开发者后台，并在开发者后台调用微信后台提供的 </font>[phonenumber.getPhoneNumber](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/phonenumber/phonenumber.getPhoneNumber.html)<font style="color:rgb(34, 34, 34);"> 接口，消费</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">来换取用户手机号。每个</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">有效期为5分钟，且只能消费一次。</font>
...
<font style="color:rgb(34, 34, 34);">将 </font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">bindgetrealtimephonenumber</font>`<font style="color:rgb(34, 34, 34);"> 事件回调中的动态令牌</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">传到开发者后台，并在开发者后台调用微信后台提供的 </font>[phonenumber.getPhoneNumber](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/phonenumber/phonenumber.getPhoneNumber.html)<font style="color:rgb(34, 34, 34);"> 接口，消费</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">来换取用户手机号。每个</font>`<font style="color:rgb(34, 34, 34);background-color:rgb(249, 249, 250);">code</font>`<font style="color:rgb(34, 34, 34);">有效期为5分钟，且只能消费一次。</font>
