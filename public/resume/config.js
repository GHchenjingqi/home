export const resumeConfig = {
    ...
    skills: [
        {name: '编程语言', text: "精通HTML5、JavaScript（ES6+）、微信原生小程序开发、React、Vue、UniAPP等前端技术"},
        {name: '框架与库', text: "精通Vue、React及其生态系统（如Vuex、Redux、Vue Router、React Router等）；熟练使用Bootstrap、Element、Ant Design、Vant等UI框架；熟练使用ThreeJS/Echarts/Amap/G2等库进行数据可视化开发。"},
        ...
        {name: '其他技能', text: '', children: [
            ...
            {text: "熟悉服务器相关知识，能使用Docker、Phpstudy、宝塔工具搭建服务器环境，完成部署工作;"},
            {text: "拥有3年UI设计经验，熟悉流行设计规范，能完成平面设计、UI界面设计及交互设计工作；"},
            {text: "热爱开源，拥抱变化，开源了多个Npm包和应用，并参与开源社区活动，分享知识。"},
    ...
    projects: [
        {   id:"101",
            ...
            content: [
                '主导该项目基础框架（若依）的搭建与整体UI改造，完成实时数据、计量查询、手动建单、车辆管理、地磅管理、报表导出及语言互联等功能模块的开发。',
        ...
        {   
            ...
            name: '会计宝小程序',url:'http://www.kjb100.com/', 
