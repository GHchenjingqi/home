...
const option1 = {
  ...
  globe: {
    // 地球贴图
    baseTexture:  '/public/images/world.jpg',
    // 环境贴图
    environment:"/public/images/sky.png",
    // 兰伯特投影： 等角圆锥投影
    shading: 'lambert',
    // 开启大气层
    atmosphere: {
...
const option2 = {
  ...
  globe: {
    ...
    baseTexture:  '/public/images/world.jpg',
    // 凹凸
    heightTexture: '/public/images/world.jpg',
    // 置换比例，凹凸大小
    ...
    layers: [
      {
        type: 'blend',
        blendTo: 'emission',
        texture: '/public/images/earth2.jpg',
      },
      {
        type: 'overlay',
        texture: '/public/images/clouds.png',
        shading: 'lambert',
        distance: 5
      }
    ],
