...
const init = async ({ THREE, scene, camera }) => {
  ...
  const envMapTexture = await loader.load(import.meta.env.VITE_BASE_URL + '/public/images/sky.webp');
  ...
  // 加载云彩贴图
  const texture = await loader.load(import.meta.env.VITE_BASE_URL + '/public/images/cloud.png');
