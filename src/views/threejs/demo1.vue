...
const meshfn = ({ THREE, scene, cube })=>{
    // 环境贴图：左右、上下、前后
    const cubeTexture = new THREE.CubeTextureLoader().setPath( import.meta.env.VITE_BASE_URL+"https://ghchenjingqi.github.io/resources/images/").load(["1.jpg", "2.jpg", "3.jpg", "4.jpg", "6.jpg", "5.jpg"]);
    scene.background = cubeTexture;

    // 贴图
    const textureLoader = new THREE.TextureLoader();
    const texture = textureLoader.load(import.meta.env.VITE_BASE_URL+"https://ghchenjingqi.github.io/resources/images/all.jpg");
